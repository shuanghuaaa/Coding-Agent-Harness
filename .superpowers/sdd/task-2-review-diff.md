...
## Diff
diff --git a/src/feedback/repeated-failure.ts b/src/feedback/repeated-failure.ts
new file mode 100644
index 0000000..f715e6f
--- /dev/null
+++ b/src/feedback/repeated-failure.ts
@@ -0,0 +1,30 @@
...
+  };
+}
diff --git a/tests/feedback/repeated-failure.test.ts b/tests/feedback/repeated-failure.test.ts
new file mode 100644
index 0000000..9034e9a
--- /dev/null
+++ b/tests/feedback/repeated-failure.test.ts
@@ -0,0 +1,38 @@
